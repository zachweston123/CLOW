# CLOW - OpenClaw on Cloudflare Workers

This repository is based on [moltworker](https://github.com/cloudflare/moltworker) and provides a setup for running [OpenClaw](https://github.com/openclaw/openclaw) (formerly Moltbot, formerly Clawdbot) personal AI assistant in a [Cloudflare Sandbox](https://developers.cloudflare.com/sandbox/).
